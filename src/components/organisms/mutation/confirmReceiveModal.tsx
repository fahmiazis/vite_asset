...
export function ConfirmReceivingModal({
  transactionNumber,
  onClose,
  onSuccess,
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl w-full max-w-sm mx-4 overflow-hidden">
        ...
        <div className="px-5 py-4">
          <div className="flex gap-2.5 p-3 bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-200 dark:border-emerald-800 rounded-xl">
            ...
            <p className="text-xs text-emerald-700 dark:text-emerald-400 leading-relaxed">
              Dengan mengkonfirmasi, kamu menyatakan bahwa seluruh aset dalam transaksi ini telah diterima dengan baik. Tindakan ini tidak dapat dibatalkan.
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-2 px-5 py-4 border-t border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/40">
          ...
          >
            ...
            {isPending ? "Mengkonfirmasi..." : "Konfirmasi terima"}
          </button>
        </div>
