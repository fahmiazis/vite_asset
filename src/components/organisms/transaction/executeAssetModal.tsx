...
export function ExecuteAssetModal({
    ...
    const { mutate: executeAsset, isPending } = useExecuteAsset(transactionNumber)
    ...
    const handleSubmit = () => {
        executeAsset(
            ...
            {
                onSuccess: () => {
                    toast.success("Asset berhasil di-execute")
                    queryClient.invalidateQueries({ queryKey: ["approval-transaction", transactionNumber] })
                    onSuccess?.()
                    onClose()
                },
                onError: () => {
                    toast.error("Gagal melakukan execute asset")
                },
            }
        )
    }
            ...
            <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl w-full max-w-sm mx-4">
                ...
                <div className="px-5 py-4">
                    ...
                    <textarea
                        ...
                        placeholder="Asset sudah digenerate, siap diterima..."
                ...
                <div className="flex gap-2 px-5 py-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    >
                        {isPending ? "Memproses..." : "Execute Asset"}
                    </button>
                </div>
