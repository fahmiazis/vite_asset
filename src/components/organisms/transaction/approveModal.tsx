...
export function ApproveModal({
  ...
  const { data: approvalId } =
    useApprovalStatus(transactionApprovalId)

  const pendingIndex =
    approvalId?.data.approvals.findIndex(
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="rounded-2xl border border-indigo-100 dark:border-indigo-500/20 bg-indigo-50/70 dark:bg-indigo-500/5 px-4 py-3">
            <div className="flex items-start gap-2">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M18 10A8 8 0 114 4.5a8 8 0 0114 5.5zm-8-3a1 1 0 10-2 0v3a1 1 0 001 1h2a1 1 0 100-2h-1V7z"
                  clipRule="evenodd"
                />
              </svg>
              ...
              <div>
                ...
                <p className="text-xs text-indigo-700 dark:text-indigo-400 mt-1 leading-relaxed">
                  {t("approveModal.confirmationDescription")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={t(
                "approveModal.notesPlaceholder"
              )}
              className="w-full px-3 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-100 placeholder:text-gray-400 resize-none transition-all"
            />
          </div>
        </div>
