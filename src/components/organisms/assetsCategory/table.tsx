...
import { assetsCategoryColumns } from './column'

interface AssetsCategoryTableProps {
  data: assetsCategoryListState[]
  isLoading?: boolean
}

export function AssetsCategoryTable({ data, isLoading }: AssetsCategoryTableProps) {
    ...
    <div className="space-y-4">
      <section className='flex items-center justify-between w-full'>
        ...
        <div className='flex gap-4 items-center'>
          <button
            onClick={() => navigate('/dashboard/assets-category/create')}
          ...
          <table className="min-w-[900px] w-full">
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200">
              {table.getRowModel().rows?.length ? (
                ...
                <tr>
                  <td
                    colSpan={assetsCategoryColumns.length}
